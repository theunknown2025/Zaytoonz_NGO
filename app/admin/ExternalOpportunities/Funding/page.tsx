...
export default function ExternalFundingPage() {
  ...
  const fetchOpportunities = async () => {
    try {
      setLoading(true);
      const response = await fetch(`/api/admin/scraped-opportunities?type=funding&status=${statusFilter}&limit=100`);
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">External Funding Opportunities</h1>
                <p className="text-gray-600">Manage scraped funding and grant opportunities from external sources</p>
              </div>
            </div>
            <button
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
            ...
            <p className="text-gray-600">
              {searchTerm 
                ...
                : `No ${statusFilter} funding opportunities available`
              }
            </p>
          </div>
        ) : (
                    ...
                    {opportunity.salary_range && (
                      <div className="mb-3">
                        <span className="px-3 py-1 bg-green-100 text-green-800 text-sm rounded-full">
                          Amount: {opportunity.salary_range}
                        </span>
                      </div>
                    )}
