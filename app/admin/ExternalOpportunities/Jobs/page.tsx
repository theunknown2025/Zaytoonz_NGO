...
export default function ExternalJobsPage() {
  ...
  const fetchOpportunities = async () => {
    try {
      setLoading(true);
      const response = await fetch(`/api/admin/scraped-opportunities?type=job&status=${statusFilter}&limit=100`);
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">External Job Opportunities</h1>
                <p className="text-gray-600">Manage scraped job opportunities from external websites</p>
              </div>
            </div>
            <button
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
            ...
            <p className="text-gray-600">
              {searchTerm 
                ...
                : `No ${statusFilter} job opportunities available`
              }
            </p>
          </div>
        ) : (
