    ...
    const fetchFundingOpportunities = async () => {
      try {
        ...
        if (response.ok) {
          ...
          console.log('Funding opportunities received:', data);
          setOpportunities(data || []);
          setTotalOpportunities(data?.length || 0);
        } else {
          console.error('Failed to fetch funding opportunities, status:', response.status);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <DataExtractor
        ...
        filename="Funding_Opportunities_Export"
        title="Export Funding Opportunities"
