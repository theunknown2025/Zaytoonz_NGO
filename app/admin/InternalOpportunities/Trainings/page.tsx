...
export default function Trainings() {
  ...
  useEffect(() => {
    const fetchTrainingOpportunities = async () => {
      try {
        ...
        console.error('Error fetching training opportunities:', error);
        setOpportunities([]);
      }
    };

    fetchTrainingOpportunities();
  }, []);
  ...
  const getCategoryIcon = (type: string) => {
    switch (type) {
      ...
      default: return <AcademicCapIcon className="w-4 h-4" />;
    }
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold text-[#556B2F]">Internal Training Opportunities</h1>
            </div>
            <div className="flex items-center gap-3">
