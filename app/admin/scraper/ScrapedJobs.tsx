...
interface Job {
  ...
  source?: string; // 'RSS Feed' or undefined
  feed_title?: string; // Title of the RSS feed if applicable
}
          ...
          <div className="bg-white p-6 rounded-lg shadow-md mb-6">
            ...
            <div className="flex gap-4">
              <input
                ...
                placeholder="Enter job posting URL (e.g., LinkedIn, Indeed, etc.)"
