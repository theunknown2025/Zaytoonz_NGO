...
export default function ExternalJobsPage() {
  ...
  const fetchOpportunities = async () => {
    try {
      setLoading(true);
      const response = await fetch('/api/admin/scraped-opportunities?type=job&status=active&limit=100');
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600">Explore job openings from top companies worldwide</p>
              </div>
            </div>
            <button
            ...
            <div className="bg-white rounded-xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="p-6">
                ...
                {selectedOpportunity.salary_range && (
                  <div className="mb-6">
                    <h4 className="text-lg font-semibold text-gray-900 mb-3">Salary</h4>
                ...
                {selectedOpportunity.tags && selectedOpportunity.tags.length > 0 && (
                  <div className="mb-6">
                    <h4 className="text-lg font-semibold text-gray-900 mb-3">Skills & Tags</h4>
