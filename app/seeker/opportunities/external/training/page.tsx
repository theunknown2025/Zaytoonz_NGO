...
export default function ExternalTrainingPage() {
  ...
  const fetchOpportunities = async () => {
    try {
      setLoading(true);
      const response = await fetch('/api/admin/scraped-opportunities?type=training&status=active&limit=100');
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600">Enhance your skills with professional development opportunities</p>
              </div>
            </div>
            <button
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    ...
                    {selectedOpportunity.hours && (
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-gray-700">{selectedOpportunity.hours}</span>
                      </div>
                    )}
                    <div className="flex items-center space-x-2">
                ...
                {selectedOpportunity.hours && (
                  <div className="mb-6">
                    <h4 className="text-lg font-semibold text-gray-900 mb-3">Duration</h4>
                    <span className="px-4 py-2 bg-purple-100 text-purple-800 rounded-full">
                      ⏱️ {selectedOpportunity.hours}
                    </span>
                  </div>
                )}
                ...
                {selectedOpportunity.tags && selectedOpportunity.tags.length > 0 && (
                  <div className="mb-6">
                    <h4 className="text-lg font-semibold text-gray-900 mb-3">Topics & Skills</h4>
